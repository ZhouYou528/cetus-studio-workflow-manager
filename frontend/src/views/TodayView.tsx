      ...
      <div key={task.id} className={`bg-white dark:bg-slate-900 rounded-xl border transition ${
        ...
        <div className="p-3 flex items-start gap-3">
          <button onClick={() => updateCompletions({ ...completions, [completionKey]: !isCompleted })}
            className={`w-5 h-5 mt-0.5 rounded-full border-2 flex items-center justify-center shrink-0 ${isCompleted ? 'bg-emerald-500 border-emerald-500 task-done' : 'border-slate-300 dark:border-slate-600 hover:border-slate-500'}`}>
